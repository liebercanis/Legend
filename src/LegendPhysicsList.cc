...
// Constructor /////////////////////////////////////////////////////////////
LegendPhysicsList::LegendPhysicsList() : G4VUserPhysicsList() 
{
...
// Destructor //////////////////////////////////////////////////////////////
LegendPhysicsList::~LegendPhysicsList() 
{;}


// Construct Particles /////////////////////////////////////////////////////
void LegendPhysicsList::ConstructParticle() 
{
...
// construct Bosons://///////////////////////////////////////////////////
void LegendPhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void LegendPhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void LegendPhysicsList::ConstructMyHadrons()
{
 //  mesons
...
void LegendPhysicsList::ConstructMyShortLiveds()
{
...
// Construct Processes //////////////////////////////////////////////////////
void LegendPhysicsList::ConstructProcess() 
{
  ...
  //ConstructHad();//slows run time down 
...
// Transportation ///////////////////////////////////////////////////////////
#include "LegendMaxTimeCuts.hh"
#include "LegendMinEkineCuts.hh"
#include "G4StepLimiter.hh"

void LegendPhysicsList::AddTransportation() {
  ...
  while( (*particleIterator)() ){
    ...
    if(particleName == "neutron") 
      pmanager->AddDiscreteProcess(new LegendMaxTimeCuts());
    // Energy cuts to kill charged (embedded in method) particles:
    pmanager->AddDiscreteProcess(new LegendMinEkineCuts());
...
void LegendPhysicsList::ConstructEM() {
...
void LegendPhysicsList::ConstructHad() 
{
  //Elastic models
...
void LegendPhysicsList::ConstructGeneral() {
...
// Cuts /////////////////////////////////////////////////////////////////////
void LegendPhysicsList::SetCuts() 
{
  
  if (verboseLevel >1)
    G4cout << "LegendPhysicsList::SetCuts:";
