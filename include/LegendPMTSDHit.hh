...
//---------------------------------------------------------------------------//
/**
 * CLASS DECLARATION:  LegendPMTSDHit.hh
 *
 * DESCRIPTION:
 *
 * AUTHOR:
...
#ifndef LegendPMTSDHit_h
#define LegendPMTSDHit_h 1
...
class LegendPMTSDHit : public G4VHit
{
public:
  ...
  /// Constructor
  LegendPMTSDHit(G4LogicalVolume* logVol);

  /// Destructor
  ~LegendPMTSDHit();

  /// Copy constructor
  LegendPMTSDHit(const LegendPMTSDHit &right);

  const LegendPMTSDHit& operator=(const LegendPMTSDHit &right);
  int operator==(const LegendPMTSDHit &right) const;
...
typedef G4THitsCollection<LegendPMTSDHit> LegendPMTSDHitsCollection;

// ---------------------------------------------------------------------------

extern G4Allocator<LegendPMTSDHit> LegendPMTSDHitAllocator;

// ---------------------------------------------------------------------------

inline void* LegendPMTSDHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) LegendPMTSDHitAllocator.MallocSingle();
  return aHit;
}

// ---------------------------------------------------------------------------

inline void LegendPMTSDHit::operator delete(void *aHit)
{
  LegendPMTSDHitAllocator.FreeSingle((LegendPMTSDHit*) aHit);
}
