...
//---------------------------------------------------------------------------//
/**
 * CLASS DECLARATION:  LegendScintSDHit.hh
 *
 * DESCRIPTION:
 *
...
class LegendScintSDHit : public G4VHit
{
public:
  ...
  /// Copy constructor
  LegendScintSDHit(const LegendScintSDHit &right);

  /// Destructor
  ~LegendScintSDHit();

  const LegendScintSDHit& operator=(const LegendScintSDHit &right);
  G4int operator==(const LegendScintSDHit &right) const;
...
typedef G4THitsCollection<LegendScintSDHit> LegendScintSDHitsCollection;

// ---------------------------------------------------------------------------

extern G4Allocator<LegendScintSDHit> LegendScintSDHitAllocator;

// ---------------------------------------------------------------------------

inline void* LegendScintSDHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) LegendScintSDHitAllocator.MallocSingle();
  return aHit;
}

// ---------------------------------------------------------------------------

inline void LegendScintSDHit::operator delete(void *aHit)
{
  LegendScintSDHitAllocator.FreeSingle((LegendScintSDHit*) aHit);
}
